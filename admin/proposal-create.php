...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($proposalId) {
        ...
        header('Location: proposals.php?msg=created');
        exit;
    }
}
    ...
    <div class="card-body">
        <form method="POST" id="proposalForm">
            <div class="row">
                ...
                <div class="col-md-6 form-group mb-3">
                    ...
                    <input type="text" name="subject" class="form-control"
                        placeholder="Örn: Web Tasarım ve Hosting Teklifi" required>
                </div>
                <div class="col-md-6 form-group mb-3">
            ...
            <table class="table table-bordered" id="itemsTable">
                ...
                <tbody>
                    <tr>
                        <td><input type="text" name="item_desc[]" class="form-control" placeholder="Hizmet adı"
                                required></td>
                        <td><input type="number" name="item_qty[]" class="form-control qty" value="1" min="1" required
                                onchange="calcTotal()"></td>
                        <td><input type="number" name="item_price[]" class="form-control price" value="0.00" step="0.01"
                                required onchange="calcTotal()"></td>
            ...
            <div class="text-end">
                <a href="proposals.php" class="btn btn-secondary">İptal</a>
