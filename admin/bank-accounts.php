<?php
/**
 * WHMVM - Banka Hesapları Yönetimi
 * Havale/EFT modülü için banka bilgileri yönetimi
 */
...
<!-- Ekleme Formu -->
<div id="addForm" class="card" style="display: <?= $editAccount ? 'none' : 'block' ?>; margin-bottom: 30px;">
    <div class="card-header">
        <h3><?= $editAccount ? 'Banka Hesabı Düzenle' : 'Yeni Banka Hesabı Ekle' ?></h3>
    </div>
    <div class="card-body">
        <form method="POST">
            ...
            <div style="display: flex; gap: 10px;">
                ...
                <?php if ($editAccount): ?>
                    <a href="bank-accounts.php" class="btn btn-outline">İptal</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 8px;">
                                <a href="?edit=<?= $account['id'] ?>" class="btn btn-sm btn-outline" title="Düzenle">
