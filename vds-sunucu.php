 ...
 * Yapılandırıcı fiyatları vds_pricing tablosundan gelir; sepet.php aynı tabloyu okur.
 */
...
// Fatura dönemi indirimleri - sepet.php ile aynı olmalı
$vdsBilling = [
            ...
            <div class="vc-hero-grid">
                <div>
                    ...
                    <div class="vc-actions">
                        ...
                        <a href="iletisim.php" class="vc-btn vc-btn-outline">
        ...
        <div class="container">
            ...
            <div class="vc-help">
                <div class="vc-help-top">
                    ...
                    <a href="iletisim.php" class="vc-help-more">Tüm iletişim bilgileri</a>
                </div>
...
<script>
    (function () {
        ...
        document.getElementById('vdsOrder').addEventListener('click', function () {
            ...
            window.location.href = 'sepet.php?' + q.toString();
        });
