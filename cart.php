...
if ($eklenecek !== '') {
    ...
    $hedefler = [
        '/^(hosting|linux)/' => 'store.php?group=linux-hosting',
        '/^(windows)/' => 'store.php?group=windows-hosting',
        '/^(wordpress|wp)/' => 'store.php?group=wordpress-hosting',
        '/^ssl/' => 'store.php?group=ssl-sertifikasi',
        '/^(cloud|vps|vds)/' => 'vds.php',
        '/^(dedicated|fiziksel|sunucu)/' => 'store.php?group=fiziksel-sunucu',
        '/^domain/' => 'domain.php',
    ];
    $hedef = 'store.php';
...
<div class="ct">
    <div class="container">
        ...
        <div class="ct-top">
            ...
            <a href="store.php" class="ct-back"><i class="fas fa-arrow-left"></i> Alışverişe devam et</a>
        </div>
            ...
            <div class="ct-card">
                ...
                <?php if (!$kalemler): ?>
                    <div class="ct-empty">
                        ...
                        <a href="store.php" class="ct-checkout" style="max-width: 260px; margin: 0 auto;">
