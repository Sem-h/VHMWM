    ...
    <div class="bl">
        ...
        <section class="bl-hero">
            ...
            <div class="bl-tabs-wrap">
                <div class="container">
                    <div class="bl-tabs">
                        <a href="magaza.php" class="bl-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=btk-log-sunucu" class="bl-tab is-active"><i class="fas fa-shield-halved"></i> BTK Log
                            Sunucu</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="bl-tab">
            ...
            <div class="container">
                <div class="bl-faq-layout">
                    <div class="bl-faq-aside">
                        ...
                        <a href="iletisim.php" class="bl-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
        ...
        <section class="bl-final">
            <div class="container">
                ...
                <div class="bl-final-actions">
                    ...
                    <a href="iletisim.php" class="bl-final-link">
    ...
    <div class="fz">
        ...
        <section class="fz-hero">
            ...
            <div class="fz-tabs-wrap">
                <div class="container">
                    <div class="fz-tabs">
                        <a href="magaza.php" class="fz-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=fiziksel-sunucu" class="fz-tab is-active"><i class="fas fa-server"></i> Fiziksel
                            Sunucu</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="fz-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="fz-faq-layout">
                    <div class="fz-faq-aside">
                        ...
                        <a href="iletisim.php" class="fz-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="fz-final">
            <div class="container">
                ...
                <div class="fz-final-actions">
                    ...
                    <a href="iletisim.php" class="fz-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="lx">
        ...
        <section class="lx-hero">
            ...
            <div class="lx-tabs-wrap">
                <div class="container">
                    <div class="lx-tabs">
                        <a href="magaza.php" class="lx-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=linux-hosting" class="lx-tab is-active"><i class="fab fa-linux"></i> Linux
                            Hosting</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="lx-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="lx-faq-layout">
                    <div class="lx-faq-aside">
                        ...
                        <a href="iletisim.php" class="lx-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="lx-final">
            <div class="container">
                ...
                <div class="lx-final-actions">
                    ...
                    <a href="iletisim.php" class="lx-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="wn">
        ...
        <section class="wn-hero">
            ...
            <div class="wn-tabs-wrap">
                <div class="container">
                    <div class="wn-tabs">
                        <a href="magaza.php" class="wn-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=windows-hosting" class="wn-tab is-active"><i class="fab fa-windows"></i> Windows
                            Hosting</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="wn-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="wn-faq-layout">
                    <div class="wn-faq-aside">
                        ...
                        <a href="iletisim.php" class="wn-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="wn-final">
            <div class="container">
                ...
                <div class="wn-final-actions">
                    ...
                    <a href="iletisim.php" class="wn-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="wp">
        ...
        <section class="wp-hero">
            ...
            <div class="wp-tabs-wrap">
                <div class="container">
                    <div class="wp-tabs">
                        <a href="magaza.php" class="wp-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=wordpress-hosting" class="wp-tab is-active"><i class="fab fa-wordpress"></i> Wordpress
                            Hosting</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="wp-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="wp-faq-layout">
                    <div class="wp-faq-aside">
                        ...
                        <a href="iletisim.php" class="wp-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="wp-final">
            <div class="container">
                ...
                <div class="wp-final-actions">
                    ...
                    <a href="iletisim.php" class="wp-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="wb">
        ...
        <section class="wb-hero">
            ...
            <div class="wb-tabs-wrap">
                <div class="container">
                    <div class="wb-tabs">
                        <a href="magaza.php" class="wb-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=website-builder" class="wb-tab is-active"><i class="fas fa-wand-magic-sparkles"></i> Web Site
                            Builder</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="wb-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="wb-faq-layout">
                    <div class="wb-faq-aside">
                        ...
                        <a href="iletisim.php" class="wb-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="wb-final">
            <div class="container">
                ...
                <div class="wb-final-actions">
                    ...
                    <a href="iletisim.php" class="wb-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="arv">
        ...
        <section class="arv-hero">
            ...
            <div class="arv-tabs-wrap">
                <div class="container">
                    <div class="arv-tabs">
                        <a href="magaza.php" class="arv-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=arsiv-hosting" class="arv-tab is-active"><i class="fas fa-cloud-arrow-up"></i> Arşiv
                            Hosting</a>
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="arv-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="arv-faq-layout">
                    <div class="arv-faq-aside">
                        ...
                        <a href="iletisim.php" class="arv-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="arv-final">
            <div class="container">
                ...
                <div class="arv-final-actions">
                    ...
                    <a href="iletisim.php" class="arv-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
    ...
    <div class="kh">
        ...
        <section class="kh-hero">
            ...
            <div class="kh-tabs-wrap">
                <div class="container">
                    <div class="kh-tabs">
                        <a href="magaza.php" class="kh-tab"><i class="fas fa-th-large"></i> Tüm Ürünler</a>
                        <a href="magaza.php?group=kurumsal-hosting" class="kh-tab is-active"><i
                        ...
                        <?php foreach ($allGroups as $g):
                            ...
                            ?>
                            <a href="magaza.php?group=<?= htmlspecialchars($g['slug']) ?>" class="kh-tab">
                                <i class="fas <?= $typeConfig[$g['type'] ?? 'hosting']['icon'] ?? 'fa-box' ?>"></i>
                                <?= htmlspecialchars($g['name']) ?>
                            </a>
                        <?php endforeach; ?>
            ...
            <div class="container">
                <div class="kh-faq-layout">
                    <div class="kh-faq-aside">
                        ...
                        <a href="iletisim.php" class="kh-faq-help">
                            <i class="fas fa-headset"></i>
                            <div>
                                <b>Sorunuz listede yok mu?</b>
                                <span>Destek ekibimize yazın, aynı gün dönelim.</span>
        ...
        <section class="kh-final">
            <div class="container">
                ...
                <div class="kh-final-actions">
                    ...
                    <a href="iletisim.php" class="kh-final-link">
                        <i class="fas fa-comments"></i> Önce Soru Sormak İsterim
                    </a>
                </div>
            </div>
