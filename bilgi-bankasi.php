 ...
 *   bilgi-bankasi.php                 -> kategoriler ve popüler makaleler
 *   bilgi-bankasi.php?kategori=slug   -> kategorideki makaleler
 *   bilgi-bankasi.php?makale=slug     -> makale metni
 *   bilgi-bankasi.php?q=...           -> arama sonuçları
 *
    ...
    <section class="kb-hero">
        <div class="container">
            <div class="kb-hero-inner">
                ...
                <form class="kb-search" action="bilgi-bankasi.php" method="get" role="search">
        ...
        <div class="container">
            ...
            <?php if ($makaleSlug !== '' && !$makale): ?>
                ...
                <div class="kb-empty">
                    ...
                    <a href="bilgi-bankasi.php" class="kb-btn"><i class="fas fa-arrow-left"></i> Bilgi bankasına dön</a>
                </div>
            ...
            <?php elseif ($makale): ?>
                ...
                <div class="kb-article">
                    <div class="kb-crumb">
                        <a href="bilgi-bankasi.php">Bilgi Bankası</a>
                        <i class="fas fa-chevron-right"></i>
                        <a href="bilgi-bankasi.php?kategori=<?= urlencode((string) $makale['kategori_slug']) ?>">
                        ...
                        <div class="kb-next">
                            ...
                            <ul>
                                <?php foreach ($makaleler as $d): ?>
                                    <li>
                                        <a href="bilgi-bankasi.php?makale=<?= urlencode((string) $d['slug']) ?>">
            ...
            <?php elseif ($arama !== ''): ?>
                ...
                <?php if (!$makaleler): ?>
                    <div class="kb-empty">
                        ...
                        <a href="bilgi-bankasi.php" class="kb-btn">
                ...
                <?php else: ?>
                    <div class="kb-list">
                        <?php foreach ($makaleler as $a): ?>
                            <a class="kb-item" href="bilgi-bankasi.php?makale=<?= urlencode((string) $a['slug']) ?>">
                                <i class="fas fa-file-lines"></i>
                                <span>
            ...
            <?php elseif ($kategoriSlug !== ''): ?>
                ...
                <?php if (!$kategori): ?>
                    <div class="kb-empty">
                        ...
                        <a href="bilgi-bankasi.php" class="kb-btn"><i class="fas fa-arrow-left"></i> Geri dön</a>
                    </div>
                <?php else: ?>
                    <div class="kb-crumb">
                        <a href="bilgi-bankasi.php">Bilgi Bankası</a>
                ...
                <?php else: ?>
                    ...
                    <div class="kb-grid">
                        <?php foreach ($kategoriler as $k): ?>
                            <a class="kb-cat" href="bilgi-bankasi.php?kategori=<?= urlencode((string) $k['slug']) ?>">
                        ...
                        <div class="kb-popular">
                            ...
                            <div class="kb-list">
                                <?php foreach ($populer as $a): ?>
                                    <a class="kb-item"
                                        href="bilgi-bankasi.php?makale=<?= urlencode((string) $a['slug']) ?>">
                                        <i class="fas fa-file-lines"></i>
                                        <span>
                                            <b><?= htmlspecialchars((string) $a['baslik']) ?></b>
