...
<section class="page-hero">
    <div class="container">
        ...
        <a href="sepet.php?add=cloud" class="btn btn-primary" style="background: linear-gradient(135deg, #0ea5e9, #06b6d4);">
    ...
    <div class="container">
        ...
        <div class="pricing-grid">
            <div class="price-card">
                ...
                <a href="sepet.php?add=cloud-s" class="btn">Sipariş Ver</a>
            </div>
            <div class="price-card popular">
                ...
                <a href="sepet.php?add=cloud-m" class="btn">Sipariş Ver</a>
            </div>
            <div class="price-card">
                <h3>Cloud L</h3>
                ...
                <a href="sepet.php?add=cloud-l" class="btn">Sipariş Ver</a>
            </div>
            <div class="price-card">
                <h3>Cloud XL</h3>
                ...
                <a href="sepet.php?add=cloud-xl" class="btn">Sipariş Ver</a>
            </div>
        </div>
    </div>
</section>
